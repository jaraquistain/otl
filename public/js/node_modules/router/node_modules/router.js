...
RendererClient.reactDir = '/js/react';
RendererClient.handlebarsDir = null;
    ...
    return function () {
        ...
        function handleRoute() {
            handler.apply(handlerContext, params.concat(function(err, viewPath, data) {
                ...
                var view = router.getComponent(viewPath, data);
...
Router.prototype.getComponent = function(viewPath, data) {
    ...
    var Component = React.createFactory(require(Renderer.reactDir + '/views/' + viewPath + '.js'));
