...
RendererClient.reactDir = 'otl/app/react';
RendererClient.handlebarsDir = 'otl/app/handlebars';
    ...
    return function () {
        ...
        function handleRoute() {
            handler.apply(handlerContext, params.concat(function(err, viewPath, data) {
                ...
                data = data || {};
                data.router = router; //so components can use the router if they want
                ...
                var view = router.getComponent(('views/' + viewPath), data);

                router.renderer.render(view, routeContext.req, routeContext.res);
            }));
        }
...
Router.prototype.getComponent = function(viewPath, data) {
    console.log('view route:', Renderer.reactDir + '/' + viewPath + '.js');
    var Component = React.createFactory(require(Renderer.reactDir + '/' + viewPath + '.jsx'));
...
},{"../../renderer":1,"_process":5,"director":6,"react":152}],4:[function(require,module,exports){
'use strict';
