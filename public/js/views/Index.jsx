...
},{"../components/Renderer.jsx":1,"react":149}],3:[function(require,module,exports){
...
var CSSPropertyOperations = {
  ...
  /**
   * Serializes a mapping of style properties for use as inline scss:
   *
  ...
  /**
   * Sets the value for multiple scss on a node.  If a value is specified as
  ...
  _updateDOMProperties: function(lastProps, transaction) {
    ...
    for (propKey in nextProps) {
      ...
      if (propKey === STYLE) {
        ...
        if (lastProp) {
          // Unset scss on `lastProp` but not on `nextProp`.
          ...
          // Update scss that changed since `lastProp`.
...
var ReactDOMIDOperations = {
   ...
   *
   * @param {string} id ID of the node to update.
   * @param {object} scss Mapping from scss to values.
   * @internal
   */
